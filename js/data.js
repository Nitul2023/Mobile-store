...
const seed={
 brands:[
  {id:1,name:'Samsung',status:'Active'},{id:2,name:'Apple',status:'Active'},{id:3,name:'OnePlus',status:'Active'},{id:4,name:'Xiaomi',status:'Active'},{id:5,name:'Vivo',status:'Active'},{id:6,name:'OPPO',status:'Active'}
 ],
 models:[
...
export function load(){let x=localStorage.getItem(KEY);if(!x){localStorage.setItem(KEY,JSON.stringify(seed));return structuredClone(seed)}return JSON.parse(x)}
